...
export const Libreta = () => {
  ...
  const deleteValue = (data, index) => {
    localStorage.removeItem("contacts", data.name);
    setContacts(JSON.parse(localStorage.getItem("contacts")) || []);
  };

  return (
    <form onSubmit={handleSubmit(submitForm)} className=" p-4 flex ">
      <div className="d-flex" style={{ gap: "5px", padding: "2rem" }}>
        <div className="col-3">
      ...
      <div style={{ padding: "2rem" }}>
        <h5 className="d-flex" style={{ justifyContent: "center" }}>
          List of Contacs
        </h5>
              ...
              <tr key={index}>
                ...
                <td className="d-flex" style={{ gap: "5px" }}>
                  <button
                    ...
                    onClick={() => editValue(contact, index)}
                  >
                    Editar
                  </button>
                  <button
                    type="button"
                    className="btn btn-primary"
                    onClick={() => deleteValue(contact, index)}
                  >
                    Eliminar
                  </button>
                </td>
